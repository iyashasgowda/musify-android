...
class TRAdapter(private val context: Context, var list: ArrayList<Song>, pb: ProgressBar?, nf: TextView?) : RecyclerView.Adapter<TRAdapter.VH>(), SectionTitleProvider {
    init {
    ...
    override fun onBindViewHolder(holder: VH, p: Int) {
        ...
        holder.itemView.setOnLongClickListener {
            ...
            body.text = StringBuilder("Selected song will be removed from the Top-Rated")
