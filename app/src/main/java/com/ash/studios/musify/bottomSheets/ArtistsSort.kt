...
class ArtistsSort(private var context: Context, var rv: RecyclerView, var pb: ProgressBar, var nf: TextView) : BottomSheetDialogFragment() {
    ...
    private var prefs: SharedPreferences = context.getSharedPreferences(ARTISTS_SORT, Context.MODE_PRIVATE)
    ...
    private val checkState: Unit
        get() {
            ...
            if (prefs.getString("sort_by", "artist") == "artist") button4.isChecked = true
        }
}