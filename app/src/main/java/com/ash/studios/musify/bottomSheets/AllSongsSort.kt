...
class AllSongsSort(private val context: Context, var rv: RecyclerView, var pb: ProgressBar, var nf: TextView) : BottomSheetDialogFragment() {
    ...
    private var prefs: SharedPreferences = context.getSharedPreferences(ALL_SONGS_SORT, Context.MODE_PRIVATE)
    ...
    private fun setIDs(v: View) {
        ...
        button0.setOnCheckedChangeListener { _: CompoundButton?, checked: Boolean ->
            if (checked) {
                prefs.edit()
                    .putString("sort_by", "track")
