...
class PLBunchAdapter(private val context: Context, var list: ArrayList<Song>, private val pos: Int, pb: ProgressBar?, nf: TextView?) : RecyclerView.Adapter<PLBunchAdapter.VH>(), SectionTitleProvider {
    init {
    ...
    override fun onBindViewHolder(holder: VH, p: Int) {
        ...
        holder.itemView.setOnLongClickListener {
            ...
            body.text = StringBuilder("Selected song will be removed from the playlist")
